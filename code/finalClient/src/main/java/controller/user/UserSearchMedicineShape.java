...
public class UserSearchMedicineShape implements Initializable {
    ...
    public void viewMedicineList(ActionEvent event) {
        try {
            String front = markField.getText();
            String back = markField.getText();
            String colorFront = colorBox.getValue();
            String colorBack = colorBox.getValue();
            String shape = shapeBox.getValue();
            String chart = chartBox.getValue();
            ...
            dos.writeUTF(front);
            dos.writeUTF(back);
            dos.writeUTF(colorFront);
            dos.writeUTF(colorBack);
            dos.writeUTF(shape);
            dos.writeUTF(chart);
            ...
            Header header = new Header(
                    Header.TYPE_REQUEST,
                    Header.ACTOR_USER,
                    Header.CODE_USER_SEARCH_SHAPE_MEDICINE,
                    body.length
            );
