...
public class AdminDTO {
    ...
    public AdminDTO(int pk,String id, String pw, String name, String phone_num) {
        this.pk = pk;
        this.id = id;
        this.pw = pw;
        this.name = name;
    ...
    public static AdminDTO readAdmin(DataInputStream inputStream) throws IOException {
        ...
        return new AdminDTO(pk,id,pw,name, phone_num);
    }
    ...
    public byte[] getBytes() throws IOException {
        ...
        dos.writeBoolean(certificate_check);
//        dos.writeUTF(file);
